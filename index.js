...
const words = sentence.sentence.trim().split(" "); // Remove extra spaces and split the sentence into words
...
~console.log(words.map((word) => chalk.bold.yellow(word.toUpperCase())).join(" ")); // Convert words to uppercase and colorize in yellow
